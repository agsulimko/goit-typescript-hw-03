...
class Manager extends Employee {
  // Реалізуємо конструктор та збільшуємо salary на 10000
...
// створюэмо екземпляр класу
const manager = new Manager("Artem", "Manager", 20000);
//визиваємо метод для збільшення salary
